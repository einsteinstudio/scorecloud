			...
			<form id="addForm" action="" method="post">
				...
				<div class="form-group">
					<label for="nf-email">中文名</label> <input type="input"
						name="nameCn" class="form-control" placeholder="中文名" value="${ini.nameCn}">
				</div>
				<div class="form-group">
					<label for="nf-email">配置描述</label> <input type="input"
						name="description" class="form-control" placeholder="配置描述" value="${ini.description}">
				</div>
				<div class="form-group">
					<label for="nf-email">配置值</label> <input type="input"
						name="value" class="form-control" placeholder="配置值" value="${ini.value}">
				</div>

				<div class="form-group">
					<label for="nf-password">是否动态</label> <label
						class="switch switch-success"> <input name="changeable"
						type="checkbox" class="switch-input"  <c:if test="${ini.changeable}">checked=""</c:if> ><span
...
<script type="text/javascript" src="/manager/js/ini/ini_toModify.js"></script>
