...
<div class="main">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
				...
				<!-- 加载编辑器的容器 -->
				<label for="coverImage">个性头像：</label>
				<script id="photo" name="photo" type="text/plain">
					<img src="${userDto.account.photo}"/>
				</script>
...
<!-- 配置文件 -->
	    <script type="text/javascript" src="/manager/assets/ueditor/ueditor.config.js"></script>
	    <!-- 编辑器源码文件 -->
	    <script type="text/javascript" src="/manager/assets/ueditor/ueditor.all.js"></script>
