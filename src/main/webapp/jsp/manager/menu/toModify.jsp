	...
	<form id="menuForm" action="" method="post">
		<input type="hidden" name="id" value="${menu.id}">
		   	  <div class="form-group">
                  <label for="nf-email">上级栏目</label>
                  <input type="hidden" name="parentId" value="${pMenu.id}">
                  <input type="input"  name="parentName" class="form-control"  readonly="true" value="${pMenu.name}"> 
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                  ...
                  <div>
                   <label class="radio-inline" for="inline-radio1">
                      	<input type="radio" id="inline-radio1" name="type" checked="checked" value="MULTI"> 多篇
                      </label>
                      <label class="radio-inline" for="inline-radio1">
              ...
              <div class="form-group">
                  ...
                  <div>
                   <label class="radio-inline" for="inline-radio2">
                      	<input type="radio" id="mediaType" name="mediaType"  checked="checked" value="RICHTEXT">  富文本
                      </label>
                      <label class="radio-inline" for="inline-radio2">
                      	<input type="radio" id="mediaType" name="mediaType" value="VIDEO"> 视频
                      </label>
                      <label class="radio-inline" for="inline-radio2">
                      	<input type="radio" id="mediaType" name="mediaType" value="LIVE"> 直播
                      </label>
                     </div>
              </div>
              <div class="form-group">
                  <label for="nf-password">权重</label>
                  <input type="input" name="weight" class="form-control" placeholder="权重" value="">
              </div>
              <div class="form-group">
...
<div class="panel-footer">
                <button type="submit" class="btn btn-sm btn-info"><i class="fa fa-dot-circle-o"></i> 提交</button>
                <button id="reset"  type="button" class="btn btn-sm btn-danger"><i class="fa fa-ban"></i> 重置</button>
            	<a target="_self" href="/manager/menu/list.htm?pId=${pMenu.id}"><button id="reset"  type="button" class="btn btn-sm btn-info">返回</button></a>          	
            </div>
             </form>
     </div>
...
<script type="text/javascript" src="/manager/js/menu/toModify.js"></script>
