					...
					<div class="panel panel-default">
						<div class="panel-heading">
							...
							<div class="panel-actions">
								<c:if test="${not empty rightMap.CMS_ADD}"><a class="btn-add" href="/manager/workflow/purchaseflow_toApply.htm"><i class="fa fa-plus"></i></a></c:if>
...
<script>
	showView="${not empty rightMap.CMS_VIEW}";
            ...
            "columnDefs": [
	            {
	                "render": function ( data, type, row ) {
	                	...
	                	var html='';
	                    var viewHtml=  '<a href="view.htm?id='+data+'" class="small-btn btn-success">'+
