...
background: #CF7A7A
    	...
    	<div class="main">
    		<form action="<%=basePath%>blog/add.htm" method="post" class="basic-grey">
				...
				<input type="text" name="liveIp" id="content" value='${blog.content}' style="width:80%"/>
				<br/>
				...
				<br/>
				<br/>
				<input type="radio" name="isOpen" value="true" /> 开启转换
				<input type="radio" name="isOpen" value="false" checked="checked" /> 关闭转换
