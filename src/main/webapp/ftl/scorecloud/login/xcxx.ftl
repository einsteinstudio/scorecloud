        ...
        <div class="user-login-5">
            <div class="row bs-reset">
                <div class="col-md-6 bs-reset">
                    <div class="login-bg" style="background-image:url(${metronicPath}/assets/pages/img/login/bg1.jpg)">
                        <img class="login-logo" src="${metronicPath}/assets/pages/img/login/logo.png" /> </div>
                </div>
                <div class="col-md-6 login-container bs-reset">
                    <div class="login-content">
                        ...
                        <form action="javascript:;" class="login-form" method="post">
                            <div class="row">
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix" type="text" autocomplete="off" placeholder="用户名" name="dog" required/> </div>
                                <div class="col-xs-6">
                                    <input class="form-control form-control-solid placeholder-no-fix" type="password" autocomplete="off" placeholder="密码" name="cat" required/> </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-8 text-right">
                                    ...
                                    <button id="like" class="btn blue" type="submit">登陆</button>
                                </div>
                            </div>
                        </form>
...
<![endif]-->
        ...
        <script src="/myapp/js/scorecloud/login.js" type="text/javascript"></script>
        <!-- END PAGE LEVEL SCRIPTS -->
        <!-- BEGIN THEME LAYOUT SCRIPTS -->
        <!-- END THEME LAYOUT SCRIPTS -->
        <script type="text/javascript" src="/myapp/plugins/cypto/core.js"></script>
		<script type="text/javascript" src="/myapp/plugins/cypto/md5-min.js"></script>
