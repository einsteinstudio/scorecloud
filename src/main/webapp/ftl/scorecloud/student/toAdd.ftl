...
<#include "../templ/global.ftl"> <@framework m2="addStudent">
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input name="username" type="text" class="form-control"
									placeholder=""> <span class="tip-block">登录用户名不能重复</span>
							</div>
						</div>
					</div>
					<div class="col-md-6">
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">学号<span
								class="required">*</span></label>
							<div class="col-md-9">
								<input name="studentNo" type="text" class="form-control"
								...
								<div class="md-radio-inline">
									<div class="md-radio">
										<input type="radio" id="radioboy" name="sex"
											class="md-radiobtn" checked="" value="男"> <label for="radioboy"> <span
											class="inc"></span> <span class="check"></span> <span
											class="box"></span> 男生
										</label>
									</div>
									<div class="md-radio">
										<input type="radio" name="sex" id="radiogirl"
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input name="jiguan" type="text" class="form-control"
									placeholder="">
							</div>
						</div>
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="control-label col-md-3">入学年份<span
								class="required">*</span></label>
							<div class="col-md-9">
								<input name="enterYear" type="number" class="form-control">
							</div>
						</div>
					</div>
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<@select_class_id /> <span class="help-block">没有班级，点此<a
				...
				<div class="row">
					...
					<div class="col-md-6">
						<div class="form-group">
							...
							<div class="col-md-9">
								<input name="montherName" type="text" class="form-control">
							</div>
						</div>
					</div>
				</div>
