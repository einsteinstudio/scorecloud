...
<#include "../templ/global.ftl"> <@framework m2="modifyScore">
...
<div class="portlet box green">
	...
	<div class="portlet-body form" style="display: block;">
		<!-- BEGIN FORM-->
		<form id="form2" action="searchByExamForModify.htm" class="form-horizontal">
			<div class="form-body">
...
<div class="portlet box green">
	...
	<div class="portlet-body form" style="display: block;">
		<!-- BEGIN FORM-->
		<form id="form" action="searchByStudentForModify.htm" class="form-horizontal">
			<div class="form-body">
				<div class="alert alert-danger display-hide" style="display: none;">
					<button class="close" data-close="alert"></button>
					参数校验错误，无法提交
