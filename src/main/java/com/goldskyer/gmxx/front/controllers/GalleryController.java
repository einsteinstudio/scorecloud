...
public class GalleryController extends BlogController{

	
	@RequestMapping("/views.htm")
	public ModelAndView detail(@RequestParam String id)
	{
		ModelAndView mv = new ModelAndView("/front/gallery/view");
	...
	{
		ModelAndView mv = new ModelAndView("/front/gallery/list");
